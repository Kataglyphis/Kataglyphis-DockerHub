...
export PKG_CONFIG_PATH="${GSTREAMER_PREFIX}/${MULTIARCH_DIR}/pkgconfig:${PKG_CONFIG_PATH:-}"
export LD_LIBRARY_PATH="${GSTREAMER_PREFIX}/${MULTIARCH_DIR}${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
