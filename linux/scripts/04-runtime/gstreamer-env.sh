...
export PKG_CONFIG_PATH="${GSTREAMER_PREFIX}/${MULTIARCH_DIR}/pkgconfig:${SYSTEM_LIB}/pkgconfig:${PKG_CONFIG_PATH:-}"
export LD_LIBRARY_PATH="${GSTREAMER_PREFIX}/${MULTIARCH_DIR}:${LD_LIBRARY_PATH:-}:${SYSTEM_LIB}"
