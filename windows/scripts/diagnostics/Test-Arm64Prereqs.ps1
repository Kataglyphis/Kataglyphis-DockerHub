...
.PARAMETER Nonce
    Cache-buster forwarded by Invoke-DiagnosticProbe.ps1. Without it the RUN is
...
#
# Install-Vs.ps1's comment asserts this to justify NOT adding an SDK component
...
# into the merge stage -- not at configure. Install-ScoopTools.ps1 installs the
