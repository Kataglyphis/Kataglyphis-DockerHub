...
#
#   pwsh -File windows\scripts\diagnostics\Test-BuildCopy.ps1            # buildkit lane
#   pwsh -File windows\scripts\diagnostics\Test-BuildCopy.ps1 -Docker     # docker-classic lane too
#   pwsh -File windows\scripts\diagnostics\Test-BuildCopy.ps1 -Heavy      # + heavy-parent lane
#
