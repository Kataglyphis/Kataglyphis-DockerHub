...
#
#   pwsh -File windows\scripts\diagnostics\probe-build-copy.ps1            # buildkit lane
#   pwsh -File windows\scripts\diagnostics\probe-build-copy.ps1 -Docker     # docker-classic lane too
#   pwsh -File windows\scripts\diagnostics\probe-build-copy.ps1 -Heavy      # + heavy-parent lane
#
