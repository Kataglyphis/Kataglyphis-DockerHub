...
# solves are direct now. KEPT (with Invoke-BkMaterialize.ps1 + the handoff helpers
...
#     Invoke-BkWarm.ps1 and Invoke-BkMaterialize.ps1 are `windows/scripts/host/<n>.ps1`.
...
#     Build-TvmFromSource.ps1 throws on the missing leaf (#134).
