...
#   * dead container-store husks   - the *.bak-<stamp> trees reset-container-stores.ps1
...
#
# Usage:
#   pwsh -File windows\scripts\host\free-disk-space.ps1                 # report
#   pwsh -File windows\scripts\host\free-disk-space.ps1 -Apply          # do it
#   pwsh -File windows\scripts\host\free-disk-space.ps1 -Apply -TempOlderThanDays 14
